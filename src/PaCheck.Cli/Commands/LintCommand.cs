...
/// <summary>`pacheck lint` — run rules and report findings.</summary>
public static class LintCommand
{
    public static Command Build()
    {
        ...
        var config = new Option<string?>("--config") { Description = "Path to .pacheck.yml (default: search upward)." };
        ...
        var baseline = new Option<string?>("--baseline") { Description = "Baseline file to compare against (default .pacheck-baseline.json)." };
