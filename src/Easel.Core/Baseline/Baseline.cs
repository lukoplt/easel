...
namespace Easel.Core.Baseline;

/// <summary>
/// A set of accepted-finding fingerprints. Lets teams adopt easel on a legacy app and
...
{
    public const string DefaultFileName = ".easel-baseline.json";
