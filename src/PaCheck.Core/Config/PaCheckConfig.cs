...
/// <summary>
/// Resolved <c>.pacheck.yml</c> configuration. Keyed lookups are by rule name or id.
/// </summary>
public sealed class PaCheckConfig
{
    ...
    public static PaCheckConfig Empty { get; } = new(ConfigNode.Empty);

    public PaCheckConfig(ConfigNode root)
    {
        _root = root;
